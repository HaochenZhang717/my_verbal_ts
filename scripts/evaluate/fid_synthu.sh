...
REAL_PATH="/playpen/haochenz/my_verbal_ts/sweep_text2ts/synth_u/orig_verbalts_orig_cap_precompute_embed-lr1e-3_bs512_multistep/0/samples.pt"
FAKE_PATH="/playpen/haochenz/my_verbal_ts/sweep_text2ts/synth_u/orig_verbalts_orig_cap_precompute_embed-lr1e-3_bs512_multistep/0/samples.pt"
python calculate_fid.py \
    --real_path ${REAL_PATH} \
    --fake_path ${FAKE_PATH} \
    --ckpt_path "../fid_vae_ckpts/vae_synth_u/best.pt" \
